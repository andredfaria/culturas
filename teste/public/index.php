...
if($url[0] == 'admin') {
	$controller = "Plataforma\Controller\Admin\\" . ucfirst($controller) . 'Controller';
} else {
	$controller = "Plataforma\Controller\\" . ucfirst($controller) . 'Controller';
}

if(!class_exists($controller)) {
	print (new \Plataforma\View\View('404.phtml'))->render();
	die;
}
