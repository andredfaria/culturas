        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="input-group" name="selectCultutas" id="selectCultutas">
                            ...
                            <option name="<?= $linha['nome'] ?>" value="<?= $linha['id'] ?>">
                                <?= $linha['nome'] ?>
                            </option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="data" class="input-group" 
                               name="data" value="<?= isset($_GET['data']) ? $_GET['data'] : "" ?>"
                               placeholder="data" class="form-control input-md" required="" type="date">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <select class="input-group" id="unidade" name="unidade">
                            <option name="Alqueire" value="Alqueire">
                                Alqueire
                            </option>
                            <option name="Hectare" value="Hectare">
                                Hectare
                            </option>
                            <option name="Pés" value="Pés">
                                Pés
                            </option>
                            <option name="Metro quadrado" value="Metro quadrado">
                                Metro quadrado
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input id="quantidade" name="quantidade" 
                                   class="input-group form-control" placeholder="R$ XX,XX"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <input id="custo" class="input-group" name="custo" 
                                   class="form-control" placeholder="x dias" required=""
                                   type="text" maxlength="10" value="<?= isset($_GET['custo']) ? $_GET['custo'] : "" ?>"
                                   pattern="\[0-9]{2}\ [0-9]{4,6}-[0-9]{3,4}$">
                        </div>
                    </div>
                </div>
